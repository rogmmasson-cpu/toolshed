...
const MOCK_GROUPS = [
  {
    ...
    description: 'The original Fairhaven tool-sharing community. 5+ years strong. We share power tools, garden equipment, and everything in between.',
    isJoined: true,
    isAdmin: false,
  },
  {
  ...
  },
  {
    ...
    memberCount: 76,
    listingCount: 47,
    coverImageUrl: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=600&h=300&fit=crop',
