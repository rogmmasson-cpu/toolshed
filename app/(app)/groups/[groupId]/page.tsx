...
const MOCK_GROUPS = [
  {
    ...
    description: 'The original Austin tool-sharing community. 5+ years strong. We share power tools, garden equipment, and everything in between. Monthly swap meets at the East Austin Community Center.',
    isJoined: true,
    isAdmin: false,
  ...
  },
  {
    ...
    rules: [
      'Mueller residents only — verify your address when joining.',
  ...
  },
  {
    ...
    rules: ['Tarrytown homeowners only.', 'Rate your experience after every borrow.'],
