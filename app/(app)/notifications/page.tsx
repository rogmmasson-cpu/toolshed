...
const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    body: 'Priya Patel wants to rent your listing for 2 days starting Apr 25. Trust score: 74.',
  ...
  },
  {
    ...
    body: 'Your rental of the RYOBI Lawn Mower is due back tomorrow (Apr 12). Don\'t forget to QR check-out.',
    href: '/dashboard/rentals',
    read: true,
  ...
  },
  {
    ...
    body: 'Complete your profile to increase your trust score and get faster approvals.',
    href: '/settings',
    read: true,
